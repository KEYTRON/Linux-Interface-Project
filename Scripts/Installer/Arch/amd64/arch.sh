...
wget "https://raw.githubusercontent.com/htr-tech/Linux-Interface-Project/master/Scripts/Installer/Arch/amd64/resolv.conf" -P arch-fs/root
wget "https://raw.githubusercontent.com/htr-tech/Linux-Interface-Project/master/Scripts/Installer/Arch/amd64/additional.sh" -P arch-fs/root
echo "done"